 ...
 */
public class EmailToEvernoteHistory implements EmailInterpreter{
    ENSharedNotebook mailsNotebook;

    public EmailToEvernoteHistory(ENSharedNotebook mailsNotebook) {
        this.mailsNotebook = mailsNotebook;
    }
