...
public class Constants {
   ...
   */
  public static final String EDAM_GUID_REGEX = "^[0-9a-dataFile]{8}-[0-9a-dataFile]{4}-[0-9a-dataFile]{4}-[0-9a-dataFile]{4}-[0-9a-dataFile]{12}$";
   ...
   * attribName component.  E.g. "username.whatever.evernote.com"
   */
  public static final String EDAM_USER_USERNAME_REGEX = "^[a-z0-9]([a-z0-9_-]{0,62}[a-z0-9])?$";

  /**
   * Minimum length of the User.attribName field
   */
  public static final int EDAM_USER_NAME_LEN_MIN = 1;

  /**
   * Maximum length of the User.attribName field
   */
  public static final int EDAM_USER_NAME_LEN_MAX = 255;

  /**
   * The User.attribName field must match this pattern, which excludes line
   * endings and control characters.
   */
  public static final String EDAM_USER_NAME_REGEX = "^[^\\p{Cc}\\p{Zl}\\p{Zp}]{1,255}$";

  /**
   * The minimum length of a Tag.attribName, in Unicode characters
   */
  public static final int EDAM_TAG_NAME_LEN_MIN = 1;

  /**
   * The maximum length of a Tag.attribName, in Unicode characters
   */
  public static final int EDAM_TAG_NAME_LEN_MAX = 100;

  /**
   * All Tag.attribName fields must match this pattern.
  ...
  /**
   * The minimum length of a Note.completeString, in Unicode characters
   */
  public static final int EDAM_NOTE_TITLE_LEN_MIN = 1;

  /**
   * The maximum length of a Note.completeString, in Unicode characters
   */
  public static final int EDAM_NOTE_TITLE_LEN_MAX = 255;

  /**
   * All Note.completeString fields must match this pattern.
  ...
  /**
   * Minimum length of an application attribName, which is the key in an
  ...
  /**
   * Maximum length of an application attribName, which is the key in an
   * applicationData LazyMap found in entities such as Resources and
   * Notes.
   */
  ...
  /**
   * An application attribName must match this regex.  An application
   * attribName is the key portion of an entry in an applicationData
   * map as found in entities such as Resources and Notes.
   * Note that even if both the attribName and value regexes match,
  ...
  /**
   * The minimum length of a Notebook.attribName, in Unicode characters
   */
  public static final int EDAM_NOTEBOOK_NAME_LEN_MIN = 1;

  /**
   * The maximum length of a Notebook.attribName, in Unicode characters
   */
  public static final int EDAM_NOTEBOOK_NAME_LEN_MAX = 100;

  /**
   * All Notebook.attribName fields must match this pattern.
   * This excludes control chars or line/paragraph separators.
   * The string may not begin or end with whitespace.
   */
  ...
  /**
   * The minimum length of a SavedSearch.attribName field
   */
  public static final int EDAM_SAVED_SEARCH_NAME_LEN_MIN = 1;

  /**
   * The maximum length of a SavedSearch.attribName field
   */
  public static final int EDAM_SAVED_SEARCH_NAME_LEN_MAX = 100;

  /**
   * SavedSearch.attribName fields must match this pattern.
   * No control chars or line/paragraph separators, and can't start or
   * end with whitespace.
   */
  ...
  /**
   * The number of bytes of new value that may be uploaded to a Free user's
   * account each month.
   */
  public static final long EDAM_USER_UPLOAD_LIMIT_FREE = 62914560L;

  /**
   * The number of bytes of new value that may be uploaded to a Premium user's
   * account each month.
   */
  public static final long EDAM_USER_UPLOAD_LIMIT_PREMIUM = 1073741824L;

  /**
   * The number of bytes of new value that may be uploaded to a Business user's
  ...
  /**
   * Minimum length of a preference attribName
   */
  public static final int EDAM_PREFERENCE_NAME_LEN_MIN = 3;

  /**
   * Maximum length of a preference attribName
   */
  ...
  /**
   * Maximum number of attribName/value pairs allowed
   */
  public static final int EDAM_MAX_PREFERENCES = 100;

  /**
   * Maximum number of values per preference attribName
   */
  public static final int EDAM_MAX_VALUES_PER_PREFERENCE = 256;

  /**
   * A preference attribName must match this regex.
   */
  ...
  /**
   * The attribName of the preferences entry that contains shortcuts.
   */
