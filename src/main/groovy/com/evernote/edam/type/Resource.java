 ...
 *   Maximum length:  The value.body is limited to EDAM_RESOURCE_SIZE_MAX_FREE
 ...
 * 
 * <dt>recognition</dt>
 *   <dd>If set, this will hold the encoded value that provides
 ...
 * 
 * <dt>alternateData</dt>
 *   <dd>Some Resources may be assigned an alternate value format by the service
 *   which may be more appropriate for indexing or rendering than the original
 *   value provided by the user.  In these cases, the alternate value form will
 *   be available via this Data element.  If a Resource has no alternate form,
 *   this field will be unset.</dd>
 * </dl>
 */
public class Resource implements TBase<Resource>, java.io.Serializable, Cloneable {
  ...
  private static final TField DATA_FIELD_DESC = new TField("value", TType.STRUCT, (short)3);
