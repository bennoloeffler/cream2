 ...
 *   explicit file attribName, the original attribName will be stored here.  Many resources
 ...
 * (4kb) blob of value associated with a Resource that is not visible to the user
