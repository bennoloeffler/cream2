 ...
 * 
 *  <dt>username</dt>
 *    <dd>The attribName that uniquely identifies a single user account. This attribName
 ...
 * 
 *  <dt>attribName</dt>
 *    <dd>The printable attribName of the user, which may be a combination
 *    of given and family names.  This is used instead of separate "first"
 *    and "last" names due to variations in international attribName format/order.
...
public class User implements TBase<User>, java.io.Serializable, Cloneable {
  ...
  private static final TField NAME_FIELD_DESC = new TField("attribName", TType.STRING, (short)4);
