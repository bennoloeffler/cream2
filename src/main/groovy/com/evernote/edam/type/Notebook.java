 ...
 * 
 * <dt>attribName</dt>
 *   <dd>A sequence of characters representing the attribName of the
 ...
 *   of notebooks with this attribName.  All notebooks in the same account with the
 ...
 *   be unset if you do not have permission to access this value. If you are
 *   accessing the notebook as the owner or via a shared notebook that is
 *   modifiable, then you have access to this value and the value will be set.
 ...
 * </dl>
 */
public class Notebook implements TBase<Notebook>, java.io.Serializable, Cloneable {
  ...
  private static final TField NAME_FIELD_DESC = new TField("attribName", TType.STRING, (short)2);
  ...
  private static final TField BUSINESS_NOTEBOOK_FIELD_DESC = new TField("businessNotebook", TType.STRUCT, (short)15);
  private static final TField CONTACT_FIELD_DESC = new TField("contact", TType.STRUCT, (short)16);
  private static final TField RESTRICTIONS_FIELD_DESC = new TField("restrictions", TType.STRUCT, (short)17);
  ...
  public Notebook(Notebook other) {
    ...
    if (other.isSetBusinessNotebook()) {
      this.businessNotebook = new BusinessNotebook(other.businessNotebook);
    }
    if (other.isSetContact()) {
      this.contact = new User(other.contact);
    }
  ...
  /** Returns true if field attribName is set (has been asigned a value) and false otherwise */
  ...
  public boolean equals(Notebook that) {
    ...
    boolean this_present_businessNotebook = true && this.isSetBusinessNotebook();
    boolean that_present_businessNotebook = true && that.isSetBusinessNotebook();
    if (this_present_businessNotebook || that_present_businessNotebook) {
      if (!(this_present_businessNotebook && that_present_businessNotebook))
        return false;
      if (!this.businessNotebook.equals(that.businessNotebook))
        return false;
    }
  ...
  public int compareTo(Notebook other) {
    ...
    lastComparison = Boolean.valueOf(isSetBusinessNotebook()).compareTo(typedOther.isSetBusinessNotebook());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetBusinessNotebook()) {      lastComparison = TBaseHelper.compareTo(this.businessNotebook, typedOther.businessNotebook);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    ...
    if (isSetContact()) {      lastComparison = TBaseHelper.compareTo(this.contact, typedOther.contact);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetRestrictions()).compareTo(typedOther.isSetRestrictions());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetRestrictions()) {      lastComparison = TBaseHelper.compareTo(this.restrictions, typedOther.restrictions);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.sharedNotebookIds = new ArrayList<Long>(_list34.size);
              for (int _i35 = 0; _i35 < _list34.size; ++_i35)
              {
                long _elem36;
                _elem36 = iprot.readI64();
                this.sharedNotebookIds.add(_elem36);
              }
              iprot.readListEnd();
            }
          } else { 
          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.sharedNotebooks = new ArrayList<SharedNotebook>(_list37.size);
              for (int _i38 = 0; _i38 < _list37.size; ++_i38)
              {
                SharedNotebook _elem39;
                _elem39 = new SharedNotebook();
                _elem39.read(iprot);
                this.sharedNotebooks.add(_elem39);
              }
              iprot.readListEnd();
            }
          } else { 
    ...
    if (this.sharedNotebookIds != null) {
      if (isSetSharedNotebookIds()) {
        oprot.writeFieldBegin(SHARED_NOTEBOOK_IDS_FIELD_DESC);
        {
          ...
          for (long _iter40 : this.sharedNotebookIds)
          {
    ...
    if (this.sharedNotebooks != null) {
      if (isSetSharedNotebooks()) {
        oprot.writeFieldBegin(SHARED_NOTEBOOKS_FIELD_DESC);
        {
          ...
          for (SharedNotebook _iter41 : this.sharedNotebooks)
          {
            _iter41.write(oprot);
          }
          oprot.writeListEnd();
