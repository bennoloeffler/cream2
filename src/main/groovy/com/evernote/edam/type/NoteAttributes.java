 ...
 * 
 * <dt>placeName</dt>
 * <dd>Allows the user to assign a human-readable location attribName associated
 ...
 * (e.g., a restaurant attribName). Applications are encouraged to normalize values
 * so that grouping values by place attribName provides a useful result. Applications
 * MUST NOT automatically add place attribName values based on geolocation without
 ...
 * (4kb) blob of value that is not meant to be visible to the user and
 ...
 * Minimum length of a attribName (key): EDAM_APPLICATIONDATA_NAME_LEN_MIN
 * <br/>
 * Sum max size of key and value: EDAM_APPLICATIONDATA_ENTRY_LEN_MAX
 * <br/>
 * Syntax regex for attribName (key): EDAM_APPLICATIONDATA_NAME_REGEX
 * </dd>
 * 
 * <dt>creatorId</dt>
 ...
 * Evernote service. The key is the string attribName of the classification type,
