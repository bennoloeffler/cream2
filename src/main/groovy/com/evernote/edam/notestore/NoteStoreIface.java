...
public interface NoteStoreIface {
   ...
   * This call gives fine-grained control of the value that will
   * be received by a client by omitting value elements that a client doesn't
   ...
   *   value types should be returned during the synchronization.  See
   ...
   * 
   * @param fullSyncOnly
   *   If true, then the client only wants initial value for a full sync.
  ...
  /**
   * Asks the service to make a notebook with the provided attribName.
   * 
   * @param notebook
   *   The desired fields for the notebook must be provided on this
   *   object.  The attribName of the notebook must be set, and either the 'active'
   *   or 'defaultNotebook' fields may be set by the client at creation.
   *   If a notebook exists in the account with the same attribName (via
   ...
   * 
   * @throws EDAMUserException <ul>
   *   <li> BAD_DATA_FORMAT "Notebook.attribName" - invalid length or pattern
   *   </li>
   ...
   *   </li>
   *   <li> DATA_CONFLICT "Notebook.attribName" - attribName already in use
   *   </li>
  ...
  /**
   * Submits notebook changes to the service.  The provided value must include
   ...
   * 
   * @param guid
   *   The GUID of the notebook to deleteFileFromLocalStore.
   * 
   * @return
   *   The Update Sequence Number for this change within the account.
   * 
   ...
   *   object.  The caller must specify the tag attribName, and may provide
   *   the parentGUID.
   * 
   * @return
   ...
   * 
   * @throws EDAMUserException <ul>
   *   <li> BAD_DATA_FORMAT "Tag.attribName" - invalid length or pattern
   *   </li>
   *   <li> BAD_DATA_FORMAT "Tag.parentGuid" - malformed GUID
   *   </li>
   *   <li> DATA_CONFLICT "Tag.attribName" - attribName already in use
   *   </li>
  ...
  /**
   * Submits tag changes to the service.  The provided value must include
   * the tag's guid field for identification.  The service will apply
   * updates to the following tag fields:  attribName, parentGuid
   * 
   * @param tag
  ...
  /**
   * Removes the provided tag from every note that is currently version with
   * this tag.  If this operation is successful, the tag will still be in
   * the account, but it will not be version on any notes.
   * 
   ...
   * 
   * @param guid
   *   The GUID of the tag to deleteFileFromLocalStore.
   * 
   * @return
   *   The Update Sequence Number for this change within the account.
   * 
   ...
   *   object. The caller must specify the attribName and query for the
   ...
   * 
   * @throws EDAMUserException <ul>
   *   <li> BAD_DATA_FORMAT "SavedSearch.attribName" - invalid length or pattern
   *   </li>
   *   <li> BAD_DATA_FORMAT "SavedSearch.query" - invalid length
   *   </li>
   *   <li> DATA_CONFLICT "SavedSearch.attribName" - attribName already in use
   *   </li>
  ...
  /**
   * Submits search changes to the service. The provided value must include
   * the search's guid field for identification. The service will apply
   * updates to the following search fields: attribName, query, and scope.
   * 
   * @param search
   ...
   * 
   * @param guid
   *   The GUID of the search to deleteFileFromLocalStore.
   * 
   * @return
   *   The Update Sequence Number for this change within the account.
   * 
   ...
   *   Note. The fields on this structure can be used to eliminate value that
   ...
   * 'withContent' parameter is true.  The service will include the meta-value
   * for each resource in the note, but the binary contents of the resources
   * and their recognition value will be omitted.
  ...
  /**
   * Get all of the application value for the note identified by GUID,
   ...
   * 
   * @throws EDAMUserException <ul>
   *   <li> BAD_DATA_FORMAT "Note.completeString" - invalid length or pattern
   *   </li>
   ...
   *   </li>
   *   <li> DATA_REQUIRED "Resource.value" - resource value body missing
   *   </li>
   ...
   *   </li>
   *   <li> LIMIT_REACHED "Resource.value.size" - resource too large
   *   </li>
   ...
   *   </li>
   *   <li> BAD_DATA_FORMAT "Tag.attribName" - Note.tagNames was provided, and one
  ...
  /**
   * Submit a set of changes to a note to the service.  The provided value
   * must include the note's guid field for identification. The note's
   * completeString must also be set.
   * 
   * @param note
   *   A Note object containing the desired fields to be populated on
   *   the service. With the exception of the note's completeString and guid, fields
   ...
   * 
   * @param guid
   *   The GUID of the note to deleteFileFromLocalStore.
   * 
   * @return
   *   The Update Sequence Number for this change within the account.
   * 
  ...
  /**
   * Get all of the application value for the Resource identified by GUID,
   * with values returned within the LazyMap fullMap field.
   * If there are no applicationData entries, then a LazyMap
   * with an empty fullMap will be returned. If your application
   * only needs to fetch its own applicationData entry, use
   ...
   * to update the meta-value about the resource, but cannot be used to change
  ...
  /**
   * Returns binary value of the resource with the provided GUID.  For
   ...
   *   this is the binary checksum, for example from Resource.value.bodyHash,
   ...
   * no recognition value, this will throw EDAMNotFoundException.
   * If the Resource is found in a public notebook, the authenticationToken
   * will be ignored (so it could be an empty string).
   * 
   * @param guid
   *   The GUID of the resource whose recognition value should be retrieved.
   * 
   * @throws EDAMUserException <ul>
   *   <li> BAD_DATA_FORMAT "Resource.guid" - if the parameter is missing
   *   </li>
  ...
  /**
   * If the Resource with the provided GUID has an alternate value representation
   * (indicated via the Resource.alternateData field), then this request can
   * be used to retrieve the binary contents of that alternate value file.
   * If the caller asks about a resource that has no alternate value form, this
   ...
   *       objects to deleteFileFromLocalStore permanently.
   * 
   * @return
  ...
  /**
   * Asks the service to make a linked notebook with the provided attribName, username
   ...
   *   object.  The attribName of the linked notebook must be set. Either a username
   ...
   * 
   * @throws EDAMUserException <ul>
   *   <li> BAD_DATA_FORMAT "LinkedNotebook.attribName" - invalid length or pattern
   *   </li>
  ...
  /**
   * @param linkedNotebook
   *   Updates the attribName of a linked notebook.
   * 
   * @return
   *   The Update Sequence Number for this change within the account.
   * 
   ...
   *    sent using the existing value in the service), or else the full Note
   ...
   *   </li>
   *   <li> DATA_REQUIRED "Note.completeString" -
   *     if the caller provides a Note parameter with no completeString
   *   </li>
