 ...
 *  </dd>
 *  <dt>completeString</dt>
 *  <dd>
 *    The completeString of the note when this particular version was saved.  (The
 *    current completeString of the note may differ from this value.)
 *  </dd>
 * </dl>
 */
public class NoteVersionId implements TBase<NoteVersionId>, java.io.Serializable, Cloneable {
  ...
  /** Returns true if field completeString is set (has been asigned a value) and false otherwise */
  ...
  public void validate() throws TException {
    ...
    if (!isSetTitle()) {
      throw new TProtocolException("Required field 'completeString' is unset! Struct:" + toString());
    }
