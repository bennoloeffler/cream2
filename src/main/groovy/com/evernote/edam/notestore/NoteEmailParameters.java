 ...
 *      will be sent.  If not provided, the completeString of the note will be used
 ...
 * </dl>
 */
public class NoteEmailParameters implements TBase<NoteEmailParameters>, java.io.Serializable, Cloneable {
          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.toAddresses = new ArrayList<String>(_list86.size);
              for (int _i87 = 0; _i87 < _list86.size; ++_i87)
              {
                String _elem88;
                _elem88 = iprot.readString();
                this.toAddresses.add(_elem88);
              }
              iprot.readListEnd();
            }
          } else { 
          ...
          if (field.type == TType.LIST) {
            {
              ...
              this.ccAddresses = new ArrayList<String>(_list89.size);
              for (int _i90 = 0; _i90 < _list89.size; ++_i90)
              {
                String _elem91;
                _elem91 = iprot.readString();
                this.ccAddresses.add(_elem91);
              }
              iprot.readListEnd();
            }
          } else { 
    ...
    if (this.toAddresses != null) {
      if (isSetToAddresses()) {
        oprot.writeFieldBegin(TO_ADDRESSES_FIELD_DESC);
        {
          ...
          for (String _iter92 : this.toAddresses)
          {
    ...
    if (this.ccAddresses != null) {
      if (isSetCcAddresses()) {
        oprot.writeFieldBegin(CC_ADDRESSES_FIELD_DESC);
        {
          ...
          for (String _iter93 : this.ccAddresses)
          {
