 ...
 *  fine-grained control over the value that's returned when a client needs
 *  to synchronize with the service. Each flag in this structure specifies
 *  whether to include one class of value in the results of that call.
 * 
 * <dl>
 *  <dt>includeNotes</dt>
 *    <dd>
 ...
 *    want to watch for changes to individual Resources due to recognition value
 *    being added.
 *    </dd>
 * 
 ...
 *    <dd>
 *    If true, then the server will include the 'expunged' value for any type
 *    of included value.  For example, if 'includeTags' and 'includeExpunged'
 ...
 *  </dl>
 */
public class SyncChunkFilter implements TBase<SyncChunkFilter>, java.io.Serializable, Cloneable {
