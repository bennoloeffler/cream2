 ...
 *  <dt>attribName:</dt>
 *    <dd>
 *    The unique attribName of the profile, which is guaranteed to remain consistent across
...
public class BootstrapProfile implements TBase<BootstrapProfile>, java.io.Serializable, Cloneable {
  ...
  private static final TField NAME_FIELD_DESC = new TField("attribName", TType.STRING, (short)1);
  ...
  public void validate() throws TException {
    ...
    if (!isSetName()) {
      throw new TProtocolException("Required field 'attribName' is unset! Struct:" + toString());
    }
