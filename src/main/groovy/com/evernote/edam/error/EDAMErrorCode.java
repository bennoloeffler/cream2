 ...
 *     <dd>The format of the request value was incorrect</dd>
 ...
 *   <dt>LIMIT_REACHED</dt>
 *     <dd>Operation denied due to value model limit</dd>
 *   <dt>QUOTA_REACHED</dt>
 ...
 *   <dt>DATA_CONFLICT</dt>
 *     <dd>Change denied due to value model conflict</dd>
 *   <dt>ENML_VALIDATION</dt>
 *     <dd>Content of submitted note was malformed</dd>
 *   <dt>SHARD_UNAVAILABLE</dt>
 *     <dd>Service shard with account value is temporarily down</dd>
 *   <dt>LEN_TOO_SHORT</dt>
 *     <dd>Operation denied due to value model limit, where something such
 *         as a string length was too short</dd>
 *   <dt>LEN_TOO_LONG</dt>
 *     <dd>Operation denied due to value model limit, where something such
 *         as a string length was too long</dd>
 *   <dt>TOO_FEW</dt>
 *     <dd>Operation denied due to value model limit, where there were
