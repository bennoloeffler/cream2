...
public abstract class TTransport {
  ...
  /**
   * Is there more value to be read?
   *
   ...
   * @throws TTransportException if there was an error reading value
   */
   ...
   *
   * @param buf The output value buffer
   * @throws TTransportException if an error occurs writing value
   */
   ...
   * @throws TTransportException if there was an error writing value
   */
  public abstract void write(byte[] buf, int off, int len)
    throws TTransportException;

  /**
   * Flush any pending value out of a transport buffer.
   *
   * @throws TTransportException if there was an error writing out value.
   */
  public void flush()
    throws TTransportException {}
