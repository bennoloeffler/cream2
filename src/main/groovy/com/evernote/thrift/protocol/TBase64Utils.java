...
/**
 * Class for encoding and decoding Base64 value.
 *
 ...
 * bad value encountered when decoding is neither rejected or ignored but simply
 * results in bad decoded value -- this is not in compliance with the RFC but is
...
class TBase64Utils {
  ...
  /**
   * Encode len bytes of value in src at offset srcOff, storing the result into
  ...
  /**
   * Decode len bytes of value in src at offset srcOff, storing the result into
